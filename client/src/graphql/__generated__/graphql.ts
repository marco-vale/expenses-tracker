...
export type DeleteAllExpensesMutationVariables = Exact<{ [key: string]: never; }>;


export type DeleteAllExpensesMutation = { __typename?: 'Mutation', deleteAllExpenses: number };
...
export type MeQuery = { __typename?: 'Query', me: { __typename?: 'User', id: string, email: string, name?: string | null, picture?: string | null } };
...
export const DeleteAllExpensesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteAllExpenses"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteAllExpenses"}}]}}]} as unknown as DocumentNode<DeleteAllExpensesMutation, DeleteAllExpensesMutationVariables>;
